                                     ...
                                     bool saveAll) const
{
  ...
  mf.metaData = (saveAll ? dataset->getMetaData() :
                 dataset->getModifiedMetaData());
