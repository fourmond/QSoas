...
This section gathers the numerical performances of \texttt{QSoas} on
the tests mentioned previously.
...
reverse in the tests in the range 0 to 10.
...
\begin{center}
  \begin{tabular}{llc}
    ...
    \midrule
    \testrows{file=inline:test-laplace;test=reverse-laplace}{function@texttt,reverse@texttt,value@num}
    \\
    \bottomrule
  \end{tabular}
\end{center}
